...
namespace TritaniumBattles
{
    class Controller
    {
        ...
        static void Main(string[] args)
        {
            ...
            model.AddModelObject(ModelObjectFactory.CreateModel(ModelTypes.Asteroid, Quaterniond.Identity, new Vector3d(0,10,10)));
            model.AddModelObject(ModelObjectFactory.CreateModel(ModelTypes.Asteroid, Quaterniond.Identity, new Vector3d(0, 10, -10)));
            model.AddModelObject(ModelObjectFactory.CreateModel(ModelTypes.Asteroid, Quaterniond.Identity, new Vector3d(0, 0, 10)));
            model.AddModelObject(ModelObjectFactory.CreateModel(ModelTypes.Asteroid, Quaterniond.Identity, new Vector3d(0, 0, -10)));
            model.AddModelObject(ModelObjectFactory.CreateModel(ModelTypes.Asteroid, Quaterniond.Identity, new Vector3d(0, 10, 0)));
            model.AddModelObject(ModelObjectFactory.CreateModel(ModelTypes.Asteroid, Quaterniond.Identity, new Vector3d(0,-10, 0)));

            model.AddModelObject(ModelObjectFactory.CreateModel(ModelTypes.Asteroid, Quaterniond.Identity, new Vector3d(10, 0, 0)));
            model.AddModelObject(ModelObjectFactory.CreateModel(ModelTypes.Asteroid, Quaterniond.Identity, new Vector3d(-10, 0, 0)));
            model.AddModelObject(ModelObjectFactory.CreateModel(ModelTypes.Asteroid, Quaterniond.Identity, new Vector3d(0, 50, 10)));
            model.AddModelObject(ModelObjectFactory.CreateModel(ModelTypes.Asteroid, Quaterniond.Identity, new Vector3d(0, 10, -50)));
            model.AddModelObject(ModelObjectFactory.CreateModel(ModelTypes.Asteroid, Quaterniond.Identity, new Vector3d(5, 0, 10)));
            model.AddModelObject(ModelObjectFactory.CreateModel(ModelTypes.Asteroid, Quaterniond.Identity, new Vector3d(5, 0, -10)));
